...
This directory contains two typo-probability experiments:
...
```bash
MPLCONFIGDIR=.mplconfig python typos_on_a_page/src/markovian_tired_typist.py --output-dir typos_on_a_page/outputs
```
